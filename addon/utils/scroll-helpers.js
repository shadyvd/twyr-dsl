 ...
 */
function _calculateScrollDistribution(deltaX, deltaY, element, container, accumulator = []) {
...
export function distributeScroll(deltaX, deltaY, element, container) {
	const scrollInfos = _calculateScrollDistribution(deltaX, deltaY, element, container);
	let info = undefined;
...
export function getAvailableScroll(element, container) {
	...
	let scrollLeftMax = undefined;
	let scrollTopMax = undefined;
